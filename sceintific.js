...
function sin(){
    const display=document.getElementById("result")
    display.value=Math.sin(display.value*(Math.value/180))
...
function cos(){
    const display=document.getElementById("result")
    display.value=Math.cos(display.value*(Math.value/180))
...
function tan(){
    const display=document.getElementById("result")
    display.value=Math.tan(display.value*(Math.value/180))
...
function cot(){
    const display=document.getElementById("result")
    display.value=1/Math.tan(display.value*(Math.value/180))
